<?php
				...
				<a class="btn btn-primary" href="edit-isps1322.php?act=add"> <i class="glyphicon glyphicon-plus-sign"></i> Добавить новые предмет</a>

				<h1>Таблица Isps1322</h1>
				<p>Здесь <?php echo counting("isps1322", "id");?> строк (ну или элементов, не знаем как назвать).</p>
