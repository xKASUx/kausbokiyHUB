...
<section class="img-responsive background-radial-gradient overflow-hidden" style="height: 100vh; display: flex; align-items: center;">
  <style>
    ...
    <div class="row gx-lg-5 align-items-center mb-5">
      <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
        <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
          KausBokiy Team <br />
          <span style="color: hsl(218, 81%, 75%)">С уважением, к Артёму Борисовичу</span>
        </h1>
        <p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
          Регистрируйся скорее, там много интересного!
        </p>
      </div>
